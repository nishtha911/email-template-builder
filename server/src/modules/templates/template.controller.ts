...
export const saveTemplate = async (req: Request & { userId?: string }, res: Response) => {
  try {
...
export const getTemplates = async (req: Request & { userId?: string }, res: Response) => {
  try {
    const userId = req.userId;
...
export const getTemplateById = async (req: Request & { userId?: string }, res: Response) => {
  try {
    const { id } = req.params;
    const userId = req.userId;
    const { rows } = await pool.query(
...
export const deleteTemplate = async (req: Request & { userId?: string }, res: Response) => {
  try {
    const { id } = req.params;
    const userId = req.userId;
