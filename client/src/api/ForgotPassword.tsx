        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          {!sent ? (
            ...
            <>
              ...
              <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
                We sent a reset link to <strong style={{ color: 'var(--primary-main)' }}>{email}</strong>
              </p>
            </>
          )}
        </div>
        ...
        {!sent ? (
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 24 }}>
                ...
                <input
                  ...
                  onFocus={(e) => { e.target.style.border = '1.5px solid var(--primary-main)'; e.target.style.boxShadow = '0 0 0 3px rgba(var(--primary-rgb),0.1)'; }}
                  onBlur={(e) => { e.target.style.border = '1.5px solid rgba(var(--primary-rgb),0.18)'; e.target.style.boxShadow = 'none'; }}
                  required
                />
              </div>
          ...
          <div style={{
            ...
            <p style={{ margin: '0 0 6px', fontSize: '0.85rem', color: '#666', lineHeight: 1.6 }}>
              If you're using Ethereal for testing, open your Ethereal inbox to view the email and copy the reset link.
            </p>
